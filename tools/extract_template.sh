...
xgettext *.php */*.php --copyright-holder='Raisemanager Development Team' --package-name='GLPI - Raisemanager plugin' --package-version='0.0.1' -o locales/raisemanager.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
